...
from ttkwidgets.font.familydropdown import FontFamilyDropdown
from ttkwidgets.font.propertiesframe import FontPropertiesFrame
from ttkwidgets.font.sizedropdown import FontSizeDropdown
...
class FontSelectFrame(ttk.Frame):
    ...
    def __init__(self, master=None, callback=None, fontsize=11, **kwargs):
        """
        ...
        self._properties_frame = FontPropertiesFrame(self, callback=self._on_properties, label=False, fontsize=fontsize)
        self._grid_widgets()
